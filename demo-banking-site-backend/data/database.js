...
const USERS_TABLE_SQL =
  "CREATE TABLE users (national_id VARCHAR(255) PRIMARY KEY, firstname VARCHAR(255), lastname VARCHAR(255), address VARCHAR(255), sex VARCHAR(255), birthday DATE, profession VARCHAR(255), email VARCHAR(255))";

const ACCOUNTS_TABLE_SQL =
  "CREATE TABLE accounts (account_number VARCHAR(255) PRIMARY KEY, account_type VARCHAR(255), balance DOUBLE, user_id VARCHAR(255), creation_date DATE, status VARCHAR(255))";

const TRANSACTIONS_TABLE_SQL =
  "CREATE TABLE transactions (transaction_id VARCHAR(255) PRIMARY KEY, transaction_type VARCHAR(255), account_id VARCHAR(255), amount DOUBLE, transaction_date DATE, status VARCHAR(255), recipient_account_id VARCHAR(255))";
